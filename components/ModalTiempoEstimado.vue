  ...
  <div class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
      <div class="flex justify-between items-center p-4 border-b border-gray-200">
        <h3 class="text-lg font-semibold text-gray-800">⏱️ Establecer tiempo estimado</h3>
      ...
      <div class="p-4 space-y-4">
        <div class="bg-blue-50 p-3 rounded-lg border border-blue-200">
          ...
          <div v-if="tarjeta.tiempoSugeridoJefe > 0" class="mt-2 text-xs text-blue-600">
...
const guardarTiempo = async () => {
  ...
  try {
    ...
    // ✅ CORRECCIÓN: El endpoint devuelve la tarjeta directamente
